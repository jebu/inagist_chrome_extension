  ...
  onmessage: function(e){
      ...
      if (e.error){
        ...
        if (this.settings.toptrends)
          this.ws.send("toptrends " + this.userid);
        ...
        if (jQuery.isFunction(window[e.lookedup_tweetstat.corelation])){
          var callback = window[e.lookedup_tweetstat.corelation];
          delete window[e.lookedup_tweetstat.corelation];
          callback(e.lookedup_tweetstat);
        } else
          $(this).trigger('lookedup_tweetstat', e.lookedup_tweetstat);
      }else if (typeof e.lookedup_url != 'undefined') {
        if (jQuery.isFunction(window[e.lookedup_url.corelation])){
          var callback = window[e.lookedup_url.corelation];
          delete window[e.lookedup_url.corelation];
          callback(e.lookedup_url);
        } else
          $(this).trigger('lookedup_url', e.lookedup_url);
      }else if (typeof e.lookedup_tweet != 'undefined') {
        if (jQuery.isFunction(window[e.lookedup_tweet.corelation])){
          var callback = window[e.lookedup_tweet.corelation];
          delete window[e.lookedup_tweet.corelation];
          callback(e.lookedup_tweet);
        } else
